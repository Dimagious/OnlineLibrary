...
<div class="row">
    <div class="col-md-4" style="text-align: center;">
        <div style="display: inline-block;">
            <form method="get" action="${requestScope.contextPath}/admin/showBooks">
    ...
    <div class="col-md-4" style="text-align: center;">
        <div style="display: inline-block;">
            <form method="get" action="${requestScope.contextPath}/admin/showUsers">
                <button>Список всех пользователей</button>
            </form>
        </div>
    </div>
    <div class="col-md-4" style="text-align: center;">
        <div style="display: inline-block;">
            <form method="get" action="${requestScope.contextPath}/inner/showBooks">
                <button>Список всех книг</button>
            </form>
        </div>
    </div>
